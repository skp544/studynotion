...
import { bannerImg1, bannerImg2, bannerImg3, foundingStory } from "../assets";
...
const About = () => {
  return (
    <div>
          ...
          <div className="flex flex-col items-center gap-10 lg:flex-row justify-between">
            ...
            <div>
              <img
                src={foundingStory}
                alt="story"
                className="shadow-[0_0_20px_0] shadow-[#FC6767] scale"
              />
            </div>
          </div>
      ...
      {/* section 5 */}
      <section className="mx-auto w-11/12 max-w-maxContent flex flex-col justify-between mt-20 gap-10 text-white">
        <LearningGrid />
        <ContactFormSection />
      </section>
