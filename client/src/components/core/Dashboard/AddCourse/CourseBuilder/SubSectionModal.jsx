      ...
      <div className="my-10 w-11/12 max-w-[700px] rounded-lg border border-richblack-400 bg-richblack-800">
        ...
        >
          ...
          <div className="flex flex-col space-y-2">
            ...
            />
            {errors.lectureTitle && (
              <span className="errors-style">Lecture Title is requried</span>
            )}
          </div>

          {/* lecture description */}
          <div lassName="flex flex-col space-y-2">
            ...
            />
            {errors.lectureDesc && (
              <span className="errors-style">
                Lecture Description is requried
              </span>
            )}
          </div>
